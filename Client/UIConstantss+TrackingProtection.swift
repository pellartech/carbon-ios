...
struct UIConstantss {
    ...
    struct strings {
        ...
        static let safariInstructionsNotEnabled = String(format: NSLocalizedString("Safari.instructionsNotEnabled", value: "%@ is not enabled.", comment: "Error label when the blocker is not enabled, shown in the intro and main app when disabled"), "Carbon")
        ...
        static let titleShowMeHowOnboardingV2 = String(format: NSLocalizedString("ShowMeHowOnboarding.Title.V2", value: "Add a %@ Widget", comment: "This is the title text that is displayed in the Show Me How Onboarding Screen. %@ is the name of the app (Focus/Klar)"), "Carbon")
        ...
        static let searchInAppInstruction = String(format: searchInAppFormatInstruction, "Carbom")
        ...
        public static let widgetOnboardingCardSubtitle = String(format: NSLocalizedString(
                ...
                comment: "Subtitle shown on card view explaining the app has a widget option. %@ is the name of the app (Focus/Klar)."), "Carbon")
