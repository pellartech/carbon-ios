...
struct TrackingProtectionDetailsVM {
...
class TrackingProtectionVM {
    ...
    func getDetailsViewModel() -> TrackingProtectionDetailsVM {
        return TrackingProtectionDetailsVM(topLevelDomain: websiteTitle,
