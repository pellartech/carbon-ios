...
public enum RPCServer: Hashable, CaseIterable {
    ...
    var erc20AddressForNativeToken:String? {
        switch self {
        case .optimistic: return "0x4200000000000000000000000000000000000006"
        case .main, .goerli, .fantom, .heco, .heco_testnet, .binance_smart_chain, .binance_smart_chain_testnet, .polygon, .classic, .xDai, .mumbai_testnet, .callisto, .cronosTestnet, .fantom_testnet, .avalanche, .avalanche_testnet, .arbitrum, .palm, .palmTestnet, .optimismGoerli, .cronosMainnet, .sepolia: return nil
    ...
    public var canUserChangeGas: Bool {
        switch self {
        case .main, .goerli, .fantom, .heco, .heco_testnet, .binance_smart_chain, .binance_smart_chain_testnet, .polygon, .classic, .xDai, .mumbai_testnet, .callisto, .cronosTestnet, .fantom_testnet, .avalanche, .avalanche_testnet, .arbitrum, .palm, .palmTestnet, .optimismGoerli, .cronosMainnet, .okx, .sepolia: return true
        case .optimistic, .klaytnCypress, .klaytnBaobabTestnet, .ioTeX, .ioTeXTestnet: return false
        case .arbitrumGoerli: return false
        }
    }

    var shouldAddBufferWhenEstimatingGasPrice: Bool {
        switch self {
        case .main, .classic, .callisto, .xDai, .goerli, .binance_smart_chain, .binance_smart_chain_testnet, .heco, .heco_testnet, .fantom, .fantom_testnet, .avalanche, .avalanche_testnet, .polygon, .mumbai_testnet, .optimistic, .cronosTestnet, .arbitrum, .palm, .palmTestnet, .klaytnCypress, .klaytnBaobabTestnet, .ioTeX, .ioTeXTestnet, .optimismGoerli, .arbitrumGoerli, .cronosMainnet, .okx, .sepolia:
            return true
        }
    }

    public func etherscanContractDetailsWebPageURL(for address: String) -> URL? {
        switch self {
        case .klaytnCypress, .klaytnBaobabTestnet, .ioTeX, .ioTeXTestnet, .sepolia:
            return etherscanWebpageRoot?.appendingPathComponent("account").appendingPathComponent(walletAddress)
        case .main, .xDai, .goerli, .classic, .callisto, .binance_smart_chain, .binance_smart_chain_testnet, .heco, .heco_testnet, .fantom, .fantom_testnet, .avalanche, .avalanche_testnet, .polygon, .mumbai_testnet, .optimistic, .cronosTestnet, .arbitrum, .palm, .palmTestnet, .optimismGoerli, .arbitrumGoerli, .cronosMainnet:
            switch transactionsSource {
            case .etherscan(_, let url):
                return url.appendingPathComponent("address").appendingPathComponent(walletAddress)
            case .blockscout(_, let url):
                return url.appendingPathComponent("search").appendingQueryString("q=\(walletAddress)")
            case .covalent, .oklink, .unknown:
                return nil
            }
        case .okx:
            return URL(string: "https://www.oklink.com/okc/address/\(walletAddress)")
        }
    }

    public func etherscanTokenDetailsWebPageURL(for address: String) -> URL? {
        switch self {
        case .main, .klaytnCypress, .klaytnBaobabTestnet, .ioTeX, .ioTeXTestnet, .avalanche, .avalanche_testnet, .sepolia:
            return etherscanWebpageRoot?.appendingPathComponent("token").appendingPathComponent(walletAddress)
        case .xDai, .goerli, .classic, .callisto, .binance_smart_chain, .binance_smart_chain_testnet, .heco, .heco_testnet, .fantom, .fantom_testnet, .polygon, .mumbai_testnet, .optimistic, .cronosTestnet, .arbitrum, .palm, .palmTestnet, .optimismGoerli, .arbitrumGoerli, .cronosMainnet, .okx:
    ...
    var startBlock: UInt64 {
        switch self {
        case .xDai, .cronosTestnet, .arbitrum, .mumbai_testnet, .polygon, .optimistic, .binance_smart_chain, .binance_smart_chain_testnet, .heco, .heco_testnet, .fantom_testnet, .main, .classic, .callisto, .goerli, .fantom, .palm, .palmTestnet, .optimismGoerli, .arbitrumGoerli, .klaytnCypress, .klaytnBaobabTestnet, .ioTeX, .ioTeXTestnet, .cronosMainnet, .avalanche, .avalanche_testnet, .sepolia:
            return 0
        case .okx:
            return 2322601
        }
    ...
    var maximumBlockRangeForEvents: UInt64? {
        ...
        case .fantom_testnet:
            return 3000
        case .main, .classic, .callisto, .goerli, .fantom, .palm, .palmTestnet, .optimismGoerli, .arbitrumGoerli, .sepolia:
            return nil
    ...
    public var explorerName: String {
        ...
        case .classic, .callisto, .binance_smart_chain, .binance_smart_chain_testnet, .heco, .heco_testnet, .fantom, .fantom_testnet, .avalanche, .avalanche_testnet, .polygon, .mumbai_testnet, .optimistic, .arbitrum, .palm, .palmTestnet, .klaytnCypress, .klaytnBaobabTestnet, .ioTeX, .ioTeXTestnet, .sepolia: return "\(name) Explorer"
    ...
    public var serverWithEnhancedSupport: RPCServerWithEnhancedSupport? {
        ...
        case .goerli, .callisto, .classic, .binance_smart_chain_testnet, .heco_testnet, .fantom, .fantom_testnet, .avalanche, .avalanche_testnet, .mumbai_testnet, .optimistic, .cronosTestnet, .palm, .palmTestnet, .ioTeX, .ioTeXTestnet, .optimismGoerli, .arbitrumGoerli, .cronosMainnet, .okx, .sepolia: return nil
        }
    }
    ...
    var coinGeckoPlatform: String? {
        ...
        case .callisto, .goerli, .binance_smart_chain_testnet, .heco, .heco_testnet, .fantom_testnet, .avalanche_testnet, .mumbai_testnet, .optimistic, .cronosTestnet, .palm, .palmTestnet, .ioTeX, .ioTeXTestnet, .optimismGoerli, .arbitrumGoerli, .okx, .sepolia: return nil
        }
    }
    ...
    var coinbasePlatform: String? {
        switch self {
        case .main: return "ethereum"
        case .avalanche, .xDai, .classic, .fantom, .arbitrum, .polygon, .binance_smart_chain, .klaytnCypress, .klaytnBaobabTestnet, .callisto, .goerli, .binance_smart_chain_testnet, .heco, .heco_testnet, .fantom_testnet, .avalanche_testnet, .mumbai_testnet, .optimistic, .cronosTestnet, .palm, .palmTestnet, .ioTeX, .ioTeXTestnet, .optimismGoerli, .arbitrumGoerli, .cronosMainnet, .okx, .sepolia: return nil
        }
    }
    ...
    var rpcNodeBatchSupport: RpcNodeBatchSupport {
        ...
        case .cronosTestnet, .avalanche, .avalanche_testnet, .sepolia: return .batch(32)
        }
    }

    var conflictedServer: RPCServer? {
        for each in RPCServer.availableServers {
            if let index = RPCServer.allCases.firstIndex(where: { each == $0 }) {
