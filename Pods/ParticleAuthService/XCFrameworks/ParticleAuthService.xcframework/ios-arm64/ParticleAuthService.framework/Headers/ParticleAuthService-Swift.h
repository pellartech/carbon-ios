...
SWIFT_CLASS("_TtC19ParticleAuthService20AuthSafariController")
@interface AuthSafariController : SFSafariViewController
...
enum SocialLoginPrompt : NSInteger;
@class UserInfo;
@class ChainInfo;
...
///
/// \param loginFormMode Controls whether show light UI in web, Default value is false.
///
/// \param socialLoginPrompt Social login prompt.
///
/// \param successHandler Success handler, user info.
///
/// \param failureHandler Failure handler.
///
+ (void)loginWithType:(enum LoginType)type account:(NSString * _Nullable)account supportAuthType:(NSArray<SupportAuthType *> * _Nonnull)supportAuthType loginFormMode:(BOOL)loginFormMode socialLoginPrompt:(enum SocialLoginPrompt)socialLoginPrompt successHandler:(void (^ _Nonnull)(UserInfo * _Nullable))successHandler failureHandler:(void (^ _Nonnull)(NSError * _Nonnull))failureHandler;
/// Logout
...
/// \param failureHandler Failure handler.
///
+ (void)fastLogoutWithSuccessHandler:(void (^ _Nonnull)(NSString * _Nonnull))successHandler failureHandler:(void (^ _Nonnull)(NSError * _Nonnull))failureHandler;
/// Is user log in
///
/// returns:
...
/// Set safari page modal present style, support full screen and form sheet, Default value is form sheet.
...
/// \param half Ture is medium screen, false is large screen,  default value if false
///
+ (void)setMediumScreen:(BOOL)isMediumScreen SWIFT_AVAILABILITY(ios,introduced=15.0);
/// Set display web wallet when call signAndSendTransaction
/// \param displayWallet Default value is false
///
+ (void)setDisplayWallet:(BOOL)displayWallet;
/// Open web wallet
+ (void)openWebWallet;
/// Open account and security page
/// \param successHandler Success handler is void
///
/// \param failureHandler Failure handler
///
+ (void)openAccountAndSecurityWithSuccessHandler:(void (^ _Nonnull)(void))successHandler failureHandler:(void (^ _Nonnull)(NSError * _Nonnull))failureHandler;
...
SWIFT_CLASS("_TtC19ParticleAuthService19SecurityAccountInfo")
