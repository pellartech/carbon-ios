...
/// Config erc1155 safeTransferFrom contract parameters
/// \param contractAddress Contract address
///
/// \param from The sender address
///
...
/// Get tokens and NFTs from server
/// \param address Public address
///
/// \param tokenAddresses The parameter doesn’t work in solana, it works in evm, if you want to get all tokens, pass empty array [], if you want to get specified tokens, pass them contract address array.
///
/// \param successHandler Token Result, contains native token amount, tokens, NFTs.
///
/// \param failureHandler Error
///
...
/// \code
/// for example:
/// 100000000000000 pass "0x5AF3107A4000"
/// 3000 pas "0xBB8"
///
/// \endcode
/// \param type TxData type, 0x2 is EIP1559, 0x1 is EIP2930, 0x0 is legacy.
///
